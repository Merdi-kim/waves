  ...
  return (
    <div className='h-20 w-full flex flex-col sm:flex-row items-center px-4 lg:px-10 justify-between'>
        <div className='hidden md:flex items-center justify-center'>
            <Image height={20} width={20} src={'/assets/browse.svg'} className='h-4 w-4 mr-2' alt='browse'/>
            <span className='font-bold'>Browse</span>
        </div>
        <div className='w-[350px] lg:w-[400px] h-7 px-2 flex'>
            <Image height={20} width={20} src={'/assets/search.svg'} className='h-6 w-6' alt='search'/>
            <input type="text" className='flex-1 h-full border-none outline-none placeholder-slate-300 text-sm mx-2 bg-gray-900 rounded-lg' placeholder='Search everything' />
        </div>
        <div className='w-[150px] lg:w-[200px] h-4 flex items-center'>
            {isConnected ? <button className='pb-1 font-bold border-b-2 border-b-slate-500 hover:font-extrabold transition-all hover:text-blue-600'>Start your journey</button>:
