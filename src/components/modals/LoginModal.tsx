...
const LoginModal = ({
	...
	return (
		<div className="absolute flex items-center justify-center top-0 left-0 h-screen w-full bg-white bg-opacity-90 overflow-hidden">
			<div className="w-11/12 sm:w-9/12 lg:w-6/12 pb-8 flex flex-col items-center bg-slate-300 rounded-lg">
